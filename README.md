...
| BIN | Building Identification Number <br> Intended to be unique but in daily maintenance is not | bin | BIN |
...
| CONDO_FLAGS | This useless column is auto-maintained <br> When mappluto_bbl is not equal to base_bbl, this is Y | NA | NA |
